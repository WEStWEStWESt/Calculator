...
class LinearFileReaderTest {
    ...
    public void setUp() throws ClassNotFoundException {
        Class<?> aClass = Class.forName(LinearFileReader.class.getDeclaredClasses()[0].getName());
        createSpy(aClass);
        LinearFileReader mock = mock(LinearFileReader.class);

    }

    private <T> Object createSpy(Class<T> type) {
        return mock(type);
    }
